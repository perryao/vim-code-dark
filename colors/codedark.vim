...
" Patches gap highlight in nerdtree in neovim. See: https://github.com/neovim/neovim/issues/9019
call <sid>hi('NerdTreeFile', s:cdFront, s:cdNone, 'none', {})
call <sid>hi('NerdTreeDir', s:cdBlue, s:cdNone, 'none', {})
